...
```bash
uv tool install git+https://github.com/junhewk/hermes-medical-research.git@v0.5.2
# or
pipx install git+https://github.com/junhewk/hermes-medical-research.git@v0.5.2
```
